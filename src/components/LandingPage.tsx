...
const LandingPage = ({
  ...
  return <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-pixel-sky to-pixel-forest">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-20 left-0 w-24 h-12 bg-pixel-cloud opacity-60 rounded-pixel animate-[slide-in-right_25s_linear_infinite]" style={{
        animationDelay: '-10s'
      }} />
        <div className="absolute top-32 left-0 w-20 h-10 bg-pixel-cloud opacity-70 rounded-pixel animate-[slide-in-right_30s_linear_infinite]" style={{
        animationDelay: '-5s'
      }} />
        
        {/* Falling Leaves */}
        <div className="absolute top-0 left-1/4 w-2 h-2 bg-pixel-leaf opacity-80 animate-[fade-in_3s_ease-in-out_infinite]" style={{
        animationDelay: '0s'
      }} />
        <div className="absolute top-0 left-1/2 w-2 h-2 bg-pixel-leaf opacity-60 animate-[fade-in_4s_ease-in-out_infinite]" style={{
        animationDelay: '1s'
      }} />
        <div className="absolute top-0 left-3/4 w-2 h-2 bg-pixel-leaf opacity-70 animate-[fade-in_5s_ease-in-out_infinite]" style={{
        animationDelay: '2s'
      }} />
      ...
      <header className="relative z-10 p-6">
        <div className="flex justify-between items-center max-w-6xl mx-auto">
          ...
          <Button onClick={onGetStarted} variant="outline" className="font-pixel text-xs px-4 py-2 bg-pixel-light/10 border-pixel-light hover:bg-pixel-light hover:text-pixel-dark transition-all duration-300">
            LOGIN
          </Button>
        </div>
      </header>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <Button onClick={onGetStarted} className="font-pixel text-lg px-8 py-4 bg-gradient-to-r from-pixel-forest to-pixel-ocean hover:from-pixel-ocean hover:to-pixel-forest text-pixel-light border-2 border-pixel-light hover:scale-105 transition-all duration-300 pixel-shadow-lg animate-pulse">
            GET STARTED
          </Button>
      ...
      <div className="absolute top-1/3 right-10 w-3 h-3 bg-pixel-ocean opacity-80 animate-pulse" style={{
      animationDelay: '1s'
    }} />
      <div className="absolute bottom-1/4 left-20 w-2 h-2 bg-pixel-earth opacity-70 animate-pulse" style={{
      animationDelay: '2s'
    }} />
      <div className="absolute bottom-1/3 right-20 w-2 h-2 bg-pixel-leaf opacity-60 animate-pulse" style={{
      animationDelay: '0.5s'
    }} />
    </div>;
};
